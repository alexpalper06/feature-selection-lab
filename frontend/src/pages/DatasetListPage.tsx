      ...
      <div className="space-y-6">
        <div className="items-center justify-between">
          <div>
            ...
            <p className="text-xs text-text-main/50">Manage uploaded data sources configured for automated selectors.</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4 border-2 border-dashed border-border-main rounded-xl">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-text-main/50 max-w-xs">Upload your original tabular matrices to evaluate computational feature selection wrappers.</p>
            </div>
            <Button variant="primary" icon={Plus} onClick={() => navigate('/datasets/upload')}>
